...
!-----------------------------------------------------------
    ...
    open(1,file='bb_photint1.tab', status='unknown')
    open(2,file='bb_photintthin1.tab', status='unknown')
    open(3,file='pl_photint1.tab', status='unknown')
    open(4,file='pl_photintthin1.tab', status='unknown')
    open(9,file='bb_hphotint1.tab', status='unknown')
    open(6,file='bb_hphotintthin1.tab', status='unknown')
    open(7,file='pl_hphotint1.tab', status='unknown')
    open(8,file='pl_hphotintthin1.tab', status='unknown')


    do n=0,NumTau
      do i=1,NumFreqBnd
        write(1,*) photint(n,i)
        write(2,*) photintthin(n,i)
        write(3,*) pl_photint(n,i)
        write(4,*) pl_photintthin(n,i)
      enddo
    enddo

    do n=0,NumTau
      do i=1,NumheatBin
        write(9,*) hphotint(n,i)
        write(6,*) hphotintthin(n,i)
        write(7,*) pl_hphotint(n,i)
        write(8,*) pl_hphotintthin(n,i)
      enddo
    enddo
